                    ...
                    <div class="col-md-6">
                        <div class="px-4">
                            <a href="tourdetails?id=${tour.getId()}" style="text-decoration: none; color: #000;">
                                ...
                                <div>
                                    <h5 class="d-inline-block p-3 fw-bold" style="max-width: 100%; margin: 0; max-height: 200px;
                            ...
                            <div class="p-3">
                                <a class="btn btn-warning fw-bold " href="tourdetails?id=${tour.getId()}">
                                    Trở lại trang chi tiết
                                </a>
                            </div>
                        </div>
                    </div>
